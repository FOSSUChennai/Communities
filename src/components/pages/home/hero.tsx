...
const Hero = () => {
  return (
    <div className='relative z-10 my-16 mb-48 flex items-start bg-[#fafafa] px-4 dark:bg-[#0f0f0f] md:px-8 lg:px-16'>
      <div className='container relative mx-auto flex flex-col items-center justify-between px-4 text-center md:flex-row md:text-left'>
        ...
        >
          ...
          <motion.p
            className='mt-4 text-[20px] text-gray-600 dark:text-gray-400'
