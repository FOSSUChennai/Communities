  ...
  return (
    <div className="p-4 md:p-8 lg:p-16">
        ...
        <div className="flex items-center justify-between p-8">
          <div className="max-w-2xl">
            ...
            <div className="flex justify-center md:justify-start flex-wrap gap-4">
              ...
              <button
                className="px-6 py-2 bg-transparent border-2 border-white text-white rounded-md hover:bg-white/10 transition-colors"
      ...
      <p className="text-center mt-16 mb-2 text-gray-600">
        Made with love by Hari and Justin 💚 from <span className="text-green-500">FOSS United Chennai</span>
      </p>
    </div>
  );
};
