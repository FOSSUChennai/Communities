...
const Hero = () => {
  return (
    <div className='relative z-10 my-16 mb-48 flex items-start bg-[#fafafa] px-4 transition-colors duration-300 dark:bg-gray-900 md:px-8 lg:px-16'>
      <div className='container relative mx-auto flex flex-col items-center justify-between px-4 text-center md:flex-row md:text-left'>
        ...
        >
          <h1 className='relative text-4xl font-semibold leading-tight text-black dark:text-white md:text-[68px] lg:text-[74px]'>
            ...
            <br />
            <motion.span
              className='italic text-[#03b051] dark:text-[#05d462]'
              initial={{ opacity: 0, scale: 0.8 }}
              animate={{ opacity: 1, scale: 1 }}
      ...
      <motion.div
        className='absolute left-[15%] top-[10%] z-0 h-[350px] w-[350px] rounded-full bg-[#7eff5f]/75 blur-[140px] dark:bg-[#3d7f2f]/75 md:left-[18%] md:top-[7%] md:h-[406px] md:w-[406px] md:blur-[200px]'
