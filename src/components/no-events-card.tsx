...
export default function EmptyEventCard({
  ...
  return (
    <div className='col-span-full flex flex-col items-center justify-center rounded-xl border-2 border-gray-200 bg-gray-50 p-8 dark:border-gray-800 dark:bg-gray-900'>
