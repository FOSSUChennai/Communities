  ...
  const EventCard: React.FC<EventCardProps> = ({
    ...
    return (
      <a
        ...
        className='group relative block cursor-pointer rounded-lg p-[4px] transition-all duration-300'
        ...
        <div className='relative h-full rounded-lg border-2 border-[rgb(229,231,235)] bg-white p-4 shadow-sm transition-shadow hover:border-[rgb(255,255,255,0.5)] hover:shadow-md'>
          ...
          <div className='relative flex flex-wrap items-center justify-between gap-2'>
            {isOverflowing ? (
              <Tooltip content={communityName}>
                <div className='rounded-md border border-gray-400 bg-white px-2 py-1 text-xs text-black'>
          ...
          <div className='flex-row items-center text-sm text-gray-600'>
            <div className='flex items-center space-x-2'>
              <span
                className={`rounded bg-green-100 px-2 py-0.5 text-xs text-green-800 ring-[0.5px] ring-green-300 ring-offset-1 hover:ring-[1.5px]`}
              >
                {location}
              </span>
              <span
                className={`rounded bg-blue-100 px-2 py-0.5 text-xs text-blue-800 ring-[0.5px] ring-blue-300 ring-offset-1 hover:ring-[1.5px]`}
              >
                {date}
              </span>
              <AddToCalendar
