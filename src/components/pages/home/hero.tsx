...
const Hero = () => {
  return (
    <div className='relative z-10 my-16 mb-48 flex items-start bg-[var(--background)] px-4 md:px-8 lg:px-16'>
      <div className='container relative mx-auto flex flex-col items-center justify-between px-4 text-center md:flex-row md:text-left'>
        ...
        >
          <h1 className='relative text-4xl font-semibold leading-tight text-[var(--foreground)] md:text-[68px] lg:text-[74px]'>
            {`Don't `}
            <motion.span
          ...
          <motion.p
            className='mt-4 text-[20px] text-[var(--muted-foreground)]'
