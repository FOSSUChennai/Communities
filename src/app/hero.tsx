...
import rocket from "../../public/rocket2.svg";
...
const Hero = () => {
  ...
  return (
    <>
      ...
      <div className="bg-[#fafafa] dark:bg-dark-content px-4 md:px-8 lg:px-16 mb-48 flex my-16 items-start z-10">
      <div className="container mx-auto text-center md:text-left px-4 flex flex-col md:flex-row items-center justify-between">
        ...
        <h1 className="text-4xl text-black dark:text-white md:text-[68px] lg:text-[74px] font-semibold leading-tight">
          Dont miss your <br />
          next community
          <br />
          <span className="text-[#03b051] italic">meetup</span>
        </h1>
        <p className="mt-4 text-gray-600 dark:text-gray-300 text-[20px]">
          meet. network. share
        </p>
        </div>
        <div className="z-10">
